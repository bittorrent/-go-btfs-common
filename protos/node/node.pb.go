...
type BtfsScanTab struct {
	...
	TotalMinersIncrease             int64            `protobuf:"varint,23,opt,name=total_miners_increase,json=totalMinersIncrease,proto3" json:"total_miners_increase,omitempty" pg:"total_miners_increase"`
	BigMinersIncrease               int64            `protobuf:"varint,24,opt,name=big_miners_increase,json=bigMinersIncrease,proto3" json:"big_miners_increase,omitempty" pg:"big_miners_increase"`
	SuperOnlineMinersCountIncrease  int64            `protobuf:"varint,25,opt,name=super_online_miners_count_increase,json=superOnlineMinersCountIncrease,proto3" json:"super_online_miners_count_increase,omitempty" pg:"super_online_miners_count_increase"`
	ContractAllCountIncrease        int64            `protobuf:"varint,26,opt,name=contract_all_count_increase,json=contractAllCountIncrease,proto3" json:"contract_all_count_increase,omitempty" pg:"contract_all_count_increase"`
	ContractFailCountIncrease       int64            `protobuf:"varint,27,opt,name=contract_fail_count_increase,json=contractFailCountIncrease,proto3" json:"contract_fail_count_increase,omitempty" pg:"contract_fail_count_increase"`
	ContractAllStorageIncrease      float64          `protobuf:"fixed64,28,opt,name=contract_all_storage_increase,json=contractAllStorageIncrease,proto3" json:"contract_all_storage_increase,omitempty" pg:"contract_all_storage_increase"`
	ContractFailStorageIncrease     float64          `protobuf:"fixed64,29,opt,name=contract_fail_storage_increase,json=contractFailStorageIncrease,proto3" json:"contract_fail_storage_increase,omitempty" pg:"contract_fail_storage_increase"`
	MinersAllAmountIncrease         int64            `protobuf:"varint,30,opt,name=miners_all_amount_increase,json=minersAllAmountIncrease,proto3" json:"miners_all_amount_increase,omitempty" pg:"miners_all_amount_increase"`
	StorageLeftWhenContractIncrease float64          `protobuf:"fixed64,31,opt,name=storage_left_when_contract_increase,json=storageLeftWhenContractIncrease,proto3" json:"storage_left_when_contract_increase,omitempty" pg:"storage_left_when_contract_increase"`
	OnlineMinersNumberIncrease      int64            `protobuf:"varint,32,opt,name=online_miners_number_increase,json=onlineMinersNumberIncrease,proto3" json:"online_miners_number_increase,omitempty" pg:"online_miners_number_increase"`
	CountryDistributeByContinent    string           `protobuf:"bytes,33,opt,name=country_distribute_by_continent,json=countryDistributeByContinent,proto3" json:"country_distribute_by_continent,omitempty" pg:"country_distribute_by_continent"`
	StatDeadline                    time.Time        `protobuf:"bytes,34,opt,name=stat_deadline,json=statDeadline,proto3,stdtime" json:"stat_deadline" pg:"stat_deadline"`
	XXX_NoUnkeyedLiteral            struct{}         `json:"-" pg:"-"`
	XXX_unrecognized                []byte           `json:"-" pg:"-"`
	XXX_sizecache                   int32            `json:"-" pg:"-"`
}
...
func (m *BtfsScanTab) GetTotalMinersIncrease() int64 {
	if m != nil {
		return m.TotalMinersIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetBigMinersIncrease() int64 {
	if m != nil {
		return m.BigMinersIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetSuperOnlineMinersCountIncrease() int64 {
	if m != nil {
		return m.SuperOnlineMinersCountIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetContractAllCountIncrease() int64 {
	if m != nil {
		return m.ContractAllCountIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetContractFailCountIncrease() int64 {
	if m != nil {
		return m.ContractFailCountIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetContractAllStorageIncrease() float64 {
	if m != nil {
		return m.ContractAllStorageIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetContractFailStorageIncrease() float64 {
	if m != nil {
		return m.ContractFailStorageIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetMinersAllAmountIncrease() int64 {
	if m != nil {
		return m.MinersAllAmountIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetStorageLeftWhenContractIncrease() float64 {
	if m != nil {
		return m.StorageLeftWhenContractIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetOnlineMinersNumberIncrease() int64 {
	if m != nil {
		return m.OnlineMinersNumberIncrease
	}
	return 0
}

func (m *BtfsScanTab) GetCountryDistributeByContinent() string {
	if m != nil {
		return m.CountryDistributeByContinent
	}
	return ""
}

func (m *BtfsScanTab) GetStatDeadline() time.Time {
	if m != nil {
		return m.StatDeadline
	}
	return time.Time{}
}
...
var fileDescriptor_35f8e1f5ec2240a2 = []byte{
	...
	,
}
...
func (m *BtfsScanTab) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n22, err22 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(m.StatDeadline, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(m.StatDeadline):])
	if err22 != nil {
		return 0, err22
	}
	i -= n22
	...
	i--
	dAtA[i] = 0x92
	if len(m.CountryDistributeByContinent) > 0 {
		i -= len(m.CountryDistributeByContinent)
		copy(dAtA[i:], m.CountryDistributeByContinent)
		i = encodeVarintNode(dAtA, i, uint64(len(m.CountryDistributeByContinent)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x8a
	}
	if m.OnlineMinersNumberIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.OnlineMinersNumberIncrease))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x80
	}
	if m.StorageLeftWhenContractIncrease != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.StorageLeftWhenContractIncrease))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf9
	}
	if m.MinersAllAmountIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.MinersAllAmountIncrease))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
	}
	if m.ContractFailStorageIncrease != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ContractFailStorageIncrease))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe9
	}
	if m.ContractAllStorageIncrease != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.ContractAllStorageIncrease))))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe1
	}
	if m.ContractFailCountIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.ContractFailCountIncrease))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd8
	}
	if m.ContractAllCountIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.ContractAllCountIncrease))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd0
	}
	if m.SuperOnlineMinersCountIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.SuperOnlineMinersCountIncrease))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc8
	}
	if m.BigMinersIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.BigMinersIncrease))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc0
	}
	if m.TotalMinersIncrease != 0 {
		i = encodeVarintNode(dAtA, i, uint64(m.TotalMinersIncrease))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb8
	...
	n23, err23 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(m.DateCreated, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(m.DateCreated):])
	if err23 != nil {
		return 0, err23
	}
	i -= n23
...
func (m *ScoreHistoryTab) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n25, err25 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(m.TimeCreated, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(m.TimeCreated):])
	if err25 != nil {
		return 0, err25
	}
	i -= n25
	...
	i--
	dAtA[i] = 0x3a
	n26, err26 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(m.DateCreated, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(m.DateCreated):])
	if err26 != nil {
		return 0, err26
	}
	i -= n26
...
func (m *AirdropRewardHistoryTab) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n27, err27 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(m.TimeCreated, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(m.TimeCreated):])
	if err27 != nil {
		return 0, err27
	}
	i -= n27
	...
	i--
	dAtA[i] = 0x4a
	n28, err28 := github_com_bittorrent_protobuf_types.StdTimeMarshalTo(m.DateCreated, dAtA[i-github_com_bittorrent_protobuf_types.SizeOfStdTime(m.DateCreated):])
	if err28 != nil {
		return 0, err28
	}
	i -= n28
	i = encodeVarintNode(dAtA, i, uint64(n28))
	i--
	dAtA[i] = 0x42
	if m.Stake != 0 {
...
func NewPopulatedBtfsScanTab(r randyNode, easy bool) *BtfsScanTab {
	...
	this.TotalMinersIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.TotalMinersIncrease *= -1
	}
	this.BigMinersIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.BigMinersIncrease *= -1
	}
	this.SuperOnlineMinersCountIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.SuperOnlineMinersCountIncrease *= -1
	}
	this.ContractAllCountIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.ContractAllCountIncrease *= -1
	}
	this.ContractFailCountIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.ContractFailCountIncrease *= -1
	}
	this.ContractAllStorageIncrease = float64(r.Float64())
	if r.Intn(2) == 0 {
		this.ContractAllStorageIncrease *= -1
	}
	this.ContractFailStorageIncrease = float64(r.Float64())
	if r.Intn(2) == 0 {
		this.ContractFailStorageIncrease *= -1
	}
	this.MinersAllAmountIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.MinersAllAmountIncrease *= -1
	}
	this.StorageLeftWhenContractIncrease = float64(r.Float64())
	if r.Intn(2) == 0 {
		this.StorageLeftWhenContractIncrease *= -1
	}
	this.OnlineMinersNumberIncrease = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.OnlineMinersNumberIncrease *= -1
	}
	this.CountryDistributeByContinent = string(randStringNode(r))
	v30 := github_com_bittorrent_protobuf_types.NewPopulatedStdTime(r, easy)
	this.StatDeadline = *v30
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedNode(r, 35)
	}
	return this
}
...
func NewPopulatedAirdropRewardHistoryTab(r randyNode, easy bool) *AirdropRewardHistoryTab {
	...
	this.DateCreated = *v33
	v34 := github_com_bittorrent_protobuf_types.NewPopulatedStdTime(r, easy)
	this.TimeCreated = *v34
...
func randFieldNode(dAtA []byte, r randyNode, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateNode(dAtA, uint64(v36))
	case 1:
		dAtA = encodeVarintPopulateNode(dAtA, uint64(key))
...
func (m *BtfsScanTab) Size() (n int) {
	...
	if m.TotalMinersIncrease != 0 {
		n += 2 + sovNode(uint64(m.TotalMinersIncrease))
	}
	if m.BigMinersIncrease != 0 {
		n += 2 + sovNode(uint64(m.BigMinersIncrease))
	}
	if m.SuperOnlineMinersCountIncrease != 0 {
		n += 2 + sovNode(uint64(m.SuperOnlineMinersCountIncrease))
	}
	if m.ContractAllCountIncrease != 0 {
		n += 2 + sovNode(uint64(m.ContractAllCountIncrease))
	}
	if m.ContractFailCountIncrease != 0 {
		n += 2 + sovNode(uint64(m.ContractFailCountIncrease))
	}
	if m.ContractAllStorageIncrease != 0 {
		n += 10
	}
	...
	if m.MinersAllAmountIncrease != 0 {
		n += 2 + sovNode(uint64(m.MinersAllAmountIncrease))
	}
	if m.StorageLeftWhenContractIncrease != 0 {
		n += 10
	}
	if m.OnlineMinersNumberIncrease != 0 {
		n += 2 + sovNode(uint64(m.OnlineMinersNumberIncrease))
	}
	l = len(m.CountryDistributeByContinent)
	if l > 0 {
		n += 2 + l + sovNode(uint64(l))
	}
	l = github_com_bittorrent_protobuf_types.SizeOfStdTime(m.StatDeadline)
	n += 2 + l + sovNode(uint64(l))
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *BtfsScanTab) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalMinersIncrease", wireType)
			}
			m.TotalMinersIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalMinersIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 24:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BigMinersIncrease", wireType)
			}
			m.BigMinersIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BigMinersIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 25:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SuperOnlineMinersCountIncrease", wireType)
			}
			m.SuperOnlineMinersCountIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SuperOnlineMinersCountIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 26:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContractAllCountIncrease", wireType)
			}
			m.ContractAllCountIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ContractAllCountIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 27:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContractFailCountIncrease", wireType)
			}
			m.ContractFailCountIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ContractFailCountIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 28:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContractAllStorageIncrease", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.ContractAllStorageIncrease = float64(math.Float64frombits(v))
		case 29:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContractFailStorageIncrease", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.ContractFailStorageIncrease = float64(math.Float64frombits(v))
		case 30:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinersAllAmountIncrease", wireType)
			}
			m.MinersAllAmountIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinersAllAmountIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 31:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field StorageLeftWhenContractIncrease", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.StorageLeftWhenContractIncrease = float64(math.Float64frombits(v))
		case 32:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnlineMinersNumberIncrease", wireType)
			}
			m.OnlineMinersNumberIncrease = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowNode
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnlineMinersNumberIncrease |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 33:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CountryDistributeByContinent", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CountryDistributeByContinent = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatDeadline", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_bittorrent_protobuf_types.StdTimeUnmarshal(&m.StatDeadline, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
